...
2. ### Definitions
    ...
    :   A Support Ticket is a task, created by completing an online form or
        sending an email to support@productScience.co.uk, which will be assigned to
...
4. ### Enhancement of the service
    ...
    3.  Changes made by Product Science under this clause 4 will normally have no detectable
...
5. ### Time allowance
    ...
    4.  In any given month, if Product Science chooses to complete work in excess of the
        ...
        completed at Product Science's absolute discretion and the fact that Product
        Science does so on one occasion will not imply that Product Science will do so
    ...
    8.  If your Time Allowance is regularly exceeded, or almost exceeded, Product Science
...
8. ### Termination
    ...
    4.  Product Science may terminate this contract without notice if you are in material
    breach.

    5.  At the end of this contract, Product Science will issue a final invoice for your
...
10. ### Confidentiality
    ...
    3.  However, Product Science do regard the following as confidential:
        ...
        2.  Personal data Product Science acquires during the course of hosting your
            website;
...
12. ### Intellectual property in your website
    ...
    3.	Where, under this agreement, we create works, such as computer programs
        ...
        Product Science that allows Product Science to use the works in the
...
13. ### Payments
    ...
    4.  Product Science may charge interest on overdue invoices at 5% over the
        Barclay's Bank base rate.

    5.  You shall make payment by BACS transfer or (if agreed in advance with
        Product Science) credit or debit card. Product Science does not accept cheques.

    6.  Credit and debit card payments are subject to a 2.5% fee.

    7.  Product Science issues invoices by email. If you require a paper invoice to be
